...
{
    public class MoveCursorAndClickWithPressedKeyCommandHandler : IRequestHandler<MoveCursorAndClickWithPressedKeyCommand, BaseImageCommandResponse>
    {
        ...
        public MoveCursorAndClickWithPressedKeyCommandHandler(IMouseTool mouseTool, IKeyboardTool keyboardTool, IScreenshotMaker screenshotMaker)
        {
        ...
        public async Task<BaseImageCommandResponse> Handle(MoveCursorAndClickWithPressedKeyCommand request, CancellationToken cancellationToken)
        {
            ...
            var envMouseOptions = request.MouseOptions.ToEnvironmentMouseClickOptions();
            await this.mouseTool.ClickAsync(envMouseOptions);
